...
class SignIn extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://shielded-basin-47764.herokuapp.com/signin' ,  {
            method: 'post',
        ...
        <article className="br3  ba  white b--white-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">
            <main className="pa4 white-80">
                <div className="measure">
                    ...
                    <div className="">
                    <input onClick={this.onSubmitSignIn} className="b ph3 pv2 input-reset ba b--white bg-transparent grow white pointer f6 dib" type="submit" value="Sign in" />
                    </div>
