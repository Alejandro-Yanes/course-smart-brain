...
class Register extends React.Component { 
    ...
    onRegistration = () => {
        fetch('https://shielded-basin-47764.herokuapp.com/register' , {
            method : 'post' ,
            ...
            <main className="pa4 white-80">
                <div className="measure">
                    ...
                    <div className="mt3">
                        ...
                        <input onChange={this.onNameChange} className="pa2 input-reset ba bg-transparent white w-100" type="text" name="email-address"  id="name" />
                    </div>
                    <div className="mt3">
                    ...
                    <div className="">
                    <input onClick={this.onRegistration} className="b ph3 pv2 input-reset ba b--white bg-transparent grow white pointer f6 dib" type="submit" value="Register" />
                    </div>
                </div>
            </main>
         </article>
